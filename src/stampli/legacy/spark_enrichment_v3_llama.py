...
from stampli.paths import REVIEWS_BASE_PARQUET, REVIEWS_ENRICHED_V3_LLAMA

# Get the absolute path of the directory containing this script
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))

BASE_PATH = str(REVIEWS_BASE_PARQUET)
ENRICHED_PATH = str(REVIEWS_ENRICHED_V3_LLAMA)

INGESTION_BATCH = 20  # Small test batch

# LLM Configuration
LLM_PROVIDER = "ollama" # Options: "openai", "ollama"
OLLAMA_MODEL = "llama3.1" # Best general purpose 8B model, "ollama"
